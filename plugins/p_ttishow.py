        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/03691465baa774e46506d.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('🔥  ↭ Main Channel ↭  🔥', url='http://t.me/Kcmovie_Request') ],
                                                                                      [ InlineKeyboardButton('🔥  ↭ DEV Channel ↭  🔥', url='http://t.me/Kc_Cinemagalu') ]
                                                                                    ] )
                )
